		...
		switch(details.reason) {
			...
			case "update":
				if (!!details.previousVersion && 
					...
					// TODO: Remove for >v1.3.1
					globals.SyncEnabled.Set(false);
					displayAlert('xBrowserSync updated to v1.3.1', 'Sync had to be disabled to apply this update. Re-enable sync to start syncing your data again.');
				}
				break;
		}
	};
