...
xBrowserSync.App.PlatformImplementation = function ($interval, $q, $timeout, platform, globals, utility, bookmarks) {
  ...
  var constants = {
    ...
    "help_Page12_Content": {
      "message": "<h4>Noticed an issue?</h4><p>If you’ve found a bug in xBrowserSync or would like to request a new feature, head on over to GitHub and <a href='https://link.xbrowsersync.org/app-issues' class='new-tab'>submit an issue</a> or check the current <a href='https://link.xbrowsersync.org/known-issues' class='new-tab'>known issues</a> to see if your issue is listed.</p><p>Calling all coders! If you would like to help make xBrowserSync better, go ahead and fork the <a href='https://link.xbrowsersync.org/app-repo' class='new-tab'>xBrowserSync GitHub repo</a> and submit a pull request.</p>"
    },
