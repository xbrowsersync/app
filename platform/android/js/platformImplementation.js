...
xBrowserSync.App.PlatformImplementation = function ($interval, $q, $timeout, platform, globals, utility, bookmarks) {
  ...
  var constants = {
    ...
    "help_Page1_Content": {
      "message": "<h4>Welcome</h4><p>Thank you for choosing xBrowserSync! Before you begin, take some time to read through the following pages to get aquainted with xBrowserSync’s features. Futher information is available in the <a href='https://www.xbrowsersync.org/#faqs' class='new-tab'>FAQs</a>.</p><p>As xBrowserSync modifies your local browser data, it is recommended that you back up your bookmarks and disable any active browser sync services to avoid conflicts.</p>"
    },
  ...
  var getHelpPages = function () {
    var pages = [
      ...
      platform.GetConstant(globals.Constants.Help_Page2_Mobile_Content),
      platform.GetConstant(globals.Constants.Help_Page3_Content),
      platform.GetConstant(globals.Constants.Help_Page4_Mobile_Content),
      platform.GetConstant(globals.Constants.Help_Page5_Content),
      platform.GetConstant(globals.Constants.Help_Page6_Mobile_Content),
      platform.GetConstant(globals.Constants.Help_Page7_Mobile_Content),
      platform.GetConstant(globals.Constants.Help_Page9_Content),
      platform.GetConstant(globals.Constants.Help_Page11_Mobile_Content),
