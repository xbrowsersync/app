...
xBrowserSync.App.PlatformImplementation = function ($interval, $q, $timeout, platform, globals, utility, bookmarks) {
  ...
  var constants = {
    ...
    "help_Page1_Chrome_Content": {
      "message": "<h4>Welcome to xBrowserSync</h4><p>Browser syncing as it should be: secure, anonymous and free!</p><p>Before you begin, take some time to read through the following pages to familiarise yourself with xBrowserSync’s features, and if you have any questions be sure to check out the <a href='https://www.xbrowsersync.org/#faqs' class='new-tab'>FAQs</a>.</p><p>As xBrowserSync modifies your local browser data, make sure to back up your browser data and disable any active browser sync services (such as <a href='https://support.google.com/chrome/answer/185277?co=GENIE.Platform=Desktop' class='new-tab'>Google Chrome Sync</a>) to avoid conflicts.</p>"
    },
    "help_Page1_Firefox_Content": {
      "message": "<h4>Welcome to xBrowserSync</h4><p>Browser syncing as it should be: secure, anonymous and free!</p><p>Before you begin, take some time to read through the following pages to familiarise yourself with xBrowserSync’s features, and if you have any questions be sure to check out the <a href='https://www.xbrowsersync.org/#faqs' class='new-tab'>FAQs</a>.</p><p>As xBrowserSync modifies your local browser data, make sure to back up your browser data and disable any active browser sync services (such as <a href='https://support.mozilla.org/kb/remove-synced-device-firefox-accounts' class='new-tab'>Firefox Sync</a>) to avoid conflicts.</p>"
    },
    "help_Page1_Android_Content": {
      "message": "<h4>Welcome to xBrowserSync</h4><p>Browser syncing as it should be: secure, anonymous and free!</p><p>Before you begin, take some time to read through the following pages to familiarise yourself with xBrowserSync’s features, and if you have any questions be sure to check out the <a href='https://www.xbrowsersync.org/#faqs' class='new-tab'>FAQs</a>.</p>"
    },
    ...
    "help_Page2_Android_Content": {
      "message": "<h4>Syncing for the first time</h4><p>First things first, head over to your desktop browser and <a href='https://www.xbrowsersync.org/#download' class='new-tab'>download</a> the xBrowserSync extension (available for Chrome and Firefox).</p><p>When you create a new sync, your existing browser data will be encrypted locally and synced to the xBrowserSync service configured in the Settings panel.</p><p>Once you have synced your desktop browser data you can use your new sync ID to access your data here.</p>"
    },
    "help_Page3_Content": {
    ...
    "help_Page11_Desktop_Content": {
      "message": "<h4>Go mobile</h4><p>Access your synced bookmarks on the move with the xBrowserSync Android app, available on Google Play store, <a href='https://apt.izzysoft.de/fdroid/index/apk/com.xBrowserSync.android' class='new-tab'>F-Droid</a> or <a href='https://github.com/xbrowsersync/app/releases' class='new-tab'>direct download</a>.</p>"
    },
