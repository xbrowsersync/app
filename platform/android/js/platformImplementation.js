...
xBrowserSync.App.PlatformImplementation = function ($interval, $q, $timeout, platform, globals, utility, bookmarks) {
  ...
  var constants = {
    ...
    "help_Page1_Chrome_Content": {
      "message": "<h4>Welcome to xBrowserSync</h4><p>Browser syncing as it should be: secure, anonymous and free!</p><p>Before you begin, take some time to read through the following pages to familiarise yourself with xBrowserSync’s features, and if you have any questions be sure to check out the <a href='https://link.xbrowsersync.org/faqs' class='new-tab'>FAQs</a>.</p><p>As xBrowserSync modifies your local browser data, make sure to back up your browser data and disable any active browser sync services (such as <a href='https://link.xbrowsersync.org/chrome-sync' class='new-tab'>Google Chrome Sync</a>) to avoid conflicts.</p>"
    },
    "help_Page1_Firefox_Content": {
      "message": "<h4>Welcome to xBrowserSync</h4><p>Browser syncing as it should be: secure, anonymous and free!</p><p>Before you begin, take some time to read through the following pages to familiarise yourself with xBrowserSync’s features, and if you have any questions be sure to check out the <a href='https://link.xbrowsersync.org/faqs' class='new-tab'>FAQs</a>.</p><p>As xBrowserSync modifies your local browser data, make sure to back up your browser data and disable any active browser sync services (such as <a href='https://link.xbrowsersync.org/firefox-sync' class='new-tab'>Firefox Sync</a>) to avoid conflicts.</p>"
    },
    "help_Page1_Android_Content": {
      "message": "<h4>Welcome to xBrowserSync</h4><p>Browser syncing as it should be: secure, anonymous and free!</p><p>Before you begin, take some time to read through the following pages to familiarise yourself with xBrowserSync’s features, and if you have any questions be sure to check out the <a href='https://link.xbrowsersync.org/faqs' class='new-tab'>FAQs</a>.</p>"
    },
    ...
    "help_Page10_Chrome_Content": {
      "message": "<h4>Use shortcuts!</h4><p>To search your bookmarks quickly, use the default keyboard shortcut (Ctrl+Space) to activate the extension, then simply press Enter to view your recent bookmarks or start typing to search.</p><p>To change the shortcut, browse to chrome://extensions/, the keyboard shortcuts option is at the bottom of the page."
    },
    "help_Page10_Firefox_Content": {
      "message": "<h4>Use shortcuts!</h4><p>To search your bookmarks quickly, use the default keyboard shortcut (Ctrl+Space) to activate the extension, then simply press Enter to view your recent bookmarks or start typing to search.</p><p>To change the shortcut, browse to about:addons then click on “Manage Extension Shortcuts” in the Settings menu."
    },
    "help_Page11_Desktop_Content": {
      "message": "<h4>Go mobile</h4><p>Access your synced bookmarks on the move with the xBrowserSync Android app, available on Google Play store, <a href='https://link.xbrowsersync.org/fdroid' class='new-tab'>F-Droid</a> or <a href='https://link.xbrowsersync.org/releases' class='new-tab'>direct download</a>.</p>"
    },
    "help_Page11_Android_Content": {
    ...
    "help_Page12_Content": {
      "message": "<h4>Noticed an issue?</h4><p>If you’ve found a bug in xBrowserSync or would like to request a new feature, head on over to GitHub and <a href='https://link.xbrowsersync.org/app-issues' class='new-tab'>submit an issue</a>.</p><p>Calling all coders! If you would like to help make xBrowserSync better, go ahead and fork the <a href='https://link.xbrowsersync.org/app-repo' class='new-tab'>xBrowserSync GitHub repo</a> and submit a pull request.</p>"
    },
  ...
  var getHelpPages = function () {
    var pages = [
      platform.GetConstant(globals.Constants.Help_Page1_Android_Content),
      platform.GetConstant(globals.Constants.Help_Page2_Android_Content),
      platform.GetConstant(globals.Constants.Help_Page3_Content),
      platform.GetConstant(globals.Constants.Help_Page4_Android_Content),
      platform.GetConstant(globals.Constants.Help_Page5_Content),
      platform.GetConstant(globals.Constants.Help_Page6_Android_Content),
      platform.GetConstant(globals.Constants.Help_Page7_Android_Content),
      platform.GetConstant(globals.Constants.Help_Page9_Content),
      platform.GetConstant(globals.Constants.Help_Page11_Android_Content),
